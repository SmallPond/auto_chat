...
def login_chat_init():
    ...
    #baby = itchat.search_friends(name=Contacts)[0]
    #print(baby)
    # 不含参数则获取自己的信息
...
def get_task():
    ...
    fileHead = fileHander.readline()                          # 读取说明行
...
if __name__ == '__main__':
    ...
    taskList = get_task()
    start_task(taskList)
    #contact = itchat.search_friends(name='dsa')
    #contact = itchat.search_friends(name='一个宝贝儿')
    #print(contact)
    #contact.send('da')
